...
Source0  : https://cpan.metacpan.org/authors/id/A/AR/ARISTOTLE/DBIx-Connector-0.59.tar.gz
...
%prep
%setup -q -n DBIx-Connector-0.59
cd %{_builddir}
tar xf %{_sourcedir}/libdbix-connector-perl_0.56-1.debian.tar.xz
cd %{_builddir}/DBIx-Connector-0.59
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/DBIx-Connector-0.59/deblicense/
pushd ..
cp -a DBIx-Connector-0.59 buildavx2
popd
